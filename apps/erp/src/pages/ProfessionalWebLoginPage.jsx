              ...
              <div className="space-y-2">
                ...
                <div className={`relative transition-all duration-200 ${focusedField === 'email' ? 'transform scale-105' : ''}`}>
                  ...
                  <input
                    ...
                    className="w-full pl-12 pr-4 bg-white/10 border border-white/20 rounded-xl text-white placeholder-blue-300/50 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent backdrop-blur-sm transition-all duration-200"
            ...
            <div className="space- pig-4">
              ...
              <div className="space- pig-3">
                ...
                <div className="bg-white/ pig-10 rounded-xl backdrop-blur-sm">
                  ...
                  <p className="text-xs text-blue-300 mt-2">— Chiyochi O., Abuja</p>
                </div>
              </div>
            </div>
